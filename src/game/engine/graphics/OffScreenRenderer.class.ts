...
class OffscreenRenderer {
    ...
    drawImage = (canvas: GameOffscreenCanvas, data: DrawImage, isDebug = false): void => {
...
const createOffscreenRenderer = (): OffscreenRenderer => {
    return new OffscreenRenderer()
}

export { createOffscreenRenderer, OffscreenRenderer }
